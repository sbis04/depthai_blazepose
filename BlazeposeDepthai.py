...
class BlazeposeDepthai:
    ...
    def recognize_pose(self, r):           
        ...
        if right_arm_angle == 90 and left_arm_angle==90 and left_elbow_Angle>175 and left_elbow_Angle<185 and right_elbow_Angle >=175 and right_elbow_Angle <185 and left_knee_Angle==90 and right_knee_Angle==180 and right_waist_Angle==135:
            r.pose = "warrior"
